        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center min-w-0">
            <Link to="/dashboard" className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900 truncate hidden sm:inline">TeamPulse</span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            {user?.subscription?.status === 'free' && (
              <button
                ...
                className="bg-primary-600 hover:bg-primary-700 text-white px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors"
              >
                Upgrade to Pro
              </button>
            )}
